...
void main() {
  ...
  String result3 = TranslationService.translateSmart(
      'Hi John, very good work', 'hindi');
  ...
  String result4 =
      TranslationService.translateSmart('Hello world!', 'hindi');
  print('Output: "$result4"');

  // Test 5: Case preservation
  print('\n5. Case Preservation:');
  print('Input: "VERY GOOD job Alex"');
  String result5 = TranslationService.translateSmart(
      'VERY GOOD job Alex', 'hindi');
